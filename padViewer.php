...
<div class="center">
    ...
    <button onclick="genPDF();" class="btn btn-primary btn-lg" style=" font-size: 150%; text-align: center;"
            type="submit" class="btn btn-default">Send PAD
    </button>

    <form action="userpage.php">
        <br><br>
        <button class="btn btn-primary btn-lg" style=" font-size: 150%; text-align: center; margin-top: -50px;"
                type="submit" class="btn btn-default">Go Back
        </button>
    </form>

    <div class="alert alert-warning" role="alert" ;
    ">Only Click Send PDF once! It will send multiple times if you keep clicking it, <br> This will be fixed very soon!
</div>
...
<div id="render" style="background-color: white; max-width: 800px; margin: 0 auto; ">
    ...
    <div class="box" style="margin: 0 auto;">
        ...
        <div class="right">
            ...
            <div class="textBox"><p
                        class="innerBox"><?php echo $_SESSION["pad-day"] . " " . $_SESSION["pad-month"] . " " . $_SESSION["pad-year"]; ?></p>
            </div>
            <br>
    ...
    <div class="box" style="height: 450px; margin: 0 auto;">
        ...
        <div class="left">
            <p style="padding-left: 25px; padding-top: 25px; font-size: 125%;"><strong>Subcontractor Details</strong>
            </p>
        ...
        <div class="right">
            ...
            <div class="textBox"><p class="innerBox"> £ <?php echo $_SESSION["pad-gross"]; ?> </p></div>
            <br>
